...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-[#F8F9FA] px-4 font-sans">
      ...
      {/* WIDENED to max-w-[460px] and adjusted padding for perfect proportions */}
      <div 
        className="relative z-10 w-full max-w-[460px] rounded-[32px] border border-white/60 bg-white/40 p-6 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.15)] backdrop-blur-2xl sm:px-8 sm:py-8"
      >
