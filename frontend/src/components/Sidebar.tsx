...
export default function Sidebar() {
    ...
    const topItems = [
        { icon: <MessageSquare className={iconClass} />, label: 'Chat', path: '/chat' },
    ...
    return (
        <aside
            className={`h-screen flex flex-col py-4 relative z-50 overflow-hidden flex-shrink-0 text-red-50 border-r border-white/10 shadow-[8px_0_32px_rgba(0,0,0,0.25)] transition-[width,padding] duration-[350ms] ease-[cubic-bezier(0.4,0,0.2,1)] ${isOpen ? 'w-64 px-2' : 'w-14 px-1.5'}`}
        >
            <SidebarBackground />
