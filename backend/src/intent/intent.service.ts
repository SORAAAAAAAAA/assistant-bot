...
export class IntentRouterService {
    ...
    private chitChatRegex = /^(hi|hello|hey|greetings|good morning|good afternoon|good evening|thanks|thank you|who are you|what can you do|how are you|bye|goodbye|who are you\?|what can you do\?)[\s!?.]*$/i;
